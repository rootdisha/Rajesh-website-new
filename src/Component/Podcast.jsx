  ...
  const episodes = [
    {
      ...
      tags: ["Product Marketing", "AI", "Career Growth"],
      keyTopics: ["Product Marketing Strategy", "Generative AI Impact", "Product Naming", "Strategic Partnerships"],
      guestInfo: "Andrea Saiz - Senior Product Marketing Manager at Unmind, Author of 'The Product Momentum Gap'",
      platforms: {
        ...
        amazon: "https://music.amazon.com/podcasts/example1"
      },
...
Very close to that.....`,
    ...
    },
    {
      ...
      guestInfo: "Mike Chen - Serial Entrepreneur & Angel Investor",
      platforms: {
        ...
        amazon: "https://music.amazon.com/podcasts/example3"
      },
      showNotes: `**Show Notes**
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex gap-3 mb-6">
                  <a href={selectedEpisode.platforms.spotify} className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2">
                    <Music className="w-4 h-4" />
                    Spotify
                  </a>
                  <a href={selectedEpisode.platforms.youtube} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2">
                    <Youtube className="w-4 h-4" />
                    YouTube
                  </a>
                  <a href={selectedEpisode.platforms.apple} className="bg-black hover:bg-gray-800 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2">
                    <Headphones className="w-4 h-4" />
                    Apple
                  </a>
                  <a href={selectedEpisode.platforms.amazon} className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2">
                ...
                <div className="flex gap-3">
                  <button className="bg-white text-[#5944e4] px-6 py-3 rounded-full font-medium hover:bg-gray-100 transition-colors flex items-center gap-2">
